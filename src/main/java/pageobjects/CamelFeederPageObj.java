...
@DefaultUrl(UrlDataProvider.CAMEL_CLUB_HOME_PAGE)
public class CamelFeederPageObj extends BasePage {
    ...
    private ImmutableMap<String, String> myDict = ImmutableMap.<String, String>builder()
            ...
            .put("NameOfTheCamel", "//*[contains(@name,'tevenev')]")
            .put("Password", "//*[contains(@name,'pass')]")
            .put("LoginButton", "input[type=image]:nth-child(1)")
            .build();
